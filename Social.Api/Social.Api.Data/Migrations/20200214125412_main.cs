        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Comments_CommentEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assets_Comments_CommentEntityId",
                        column: x => x.CommentEntityId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Assets_Posts_PostEntityId",
                        column: x => x.PostEntityId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_CommentEntityId",
                table: "Assets",
                column: "CommentEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Assets_PostEntityId",
                table: "Assets",
                column: "PostEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_CommentEntityId",
                table: "Comments",
                column: "CommentEntityId");
